// Stub genérico para todos los iconos de lucide-react usados en las páginas
const Stub = () => null
...
export const lucideIcons = {
  ...
  Filter: Stub, SortAsc: Stub, SortDesc: Stub,
  // Doctor
  UserPlus: Stub, User: Stub, Users: Stub, Stethoscope: Stub,
  Calendar: Stub, CalendarDays: Stub, CalendarCheck: Stub, CalendarSearch: Stub,
  CalendarClock: Stub, Clock: Stub, Timer: Stub, FileText: Stub, File: Stub,
  ClipboardList: Stub, Package: Stub, Layers: Stub, LayoutGrid: Stub,
  LayoutDashboard: Stub, Ban: Stub,
  // Pabellon
  Home: Stub, Inbox: Stub, Mail: Stub, Send: Stub, Activity: Stub,
  Bed: Stub, Bell: Stub, TrendingUp: Stub, BarChart3: Stub, PhoneCall: Stub,
  MessageSquare: Stub, Building2: Stub, Tag: Stub, Hash: Stub,
  // Other
